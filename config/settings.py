...
SECRET_KEY = 'django-insecure-7a-#9bj@@p=1-^0a--j&@9^m+sdcj9bbjnfb+z7u&g5!t^8kcr'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = 'RENDER' not in os.environ  # Automatically set DEBUG based on environment
...
# If Render provides a Database URL, use PostgreSQL instead
...
#Our base url to serve media files
MEDIA_URL = '/media/'
